...
import {
  View, Text, StyleSheet, Pressable, TextInput, KeyboardAvoidingView, Platform, FlatList
} from 'react-native';
import Animated, {
...
export function CommentsSheet({ postId, visible, onDismiss, onCommentAdded }: CommentsSheetProps) {
  ...
  const createMutation = useMutation({
    mutationFn: (text: string) => communityService.createComment(postId!, session!.user.id, text),
    onSuccess: () => {
